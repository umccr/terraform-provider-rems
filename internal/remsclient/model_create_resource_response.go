...
func (o *CreateResourceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateResourceResponse := _CreateResourceResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateResourceResponse)

	if err != nil {
		return err
	}

	*o = CreateResourceResponse(varCreateResourceResponse)
