...
// checks if the LicenseLocalization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicenseLocalization{}

// LicenseLocalization struct for LicenseLocalization
type LicenseLocalization struct {
	Title       string `json:"title"`
	Textcontent string `json:"textcontent"`
	// For licenses of type attachment
	AttachmentId NullableInt64 `json:"attachment-id,omitempty"`
}

type _LicenseLocalization LicenseLocalization
...
func (o *LicenseLocalization) SetAttachmentIdNil() {
...
func (o LicenseLocalization) MarshalJSON() ([]byte, error) {
...
func (o LicenseLocalization) ToMap() (map[string]interface{}, error) {
...
func (o *LicenseLocalization) UnmarshalJSON(data []byte) (err error) {
	...
	varLicenseLocalization := _LicenseLocalization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLicenseLocalization)

	if err != nil {
		return err
	}

	*o = LicenseLocalization(varLicenseLocalization)

	return err
}

type NullableLicenseLocalization struct {
	value *LicenseLocalization
	isSet bool
}

func (v NullableLicenseLocalization) Get() *LicenseLocalization {
	return v.value
}

func (v *NullableLicenseLocalization) Set(val *LicenseLocalization) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseLocalization) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseLocalization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseLocalization(val *LicenseLocalization) *NullableLicenseLocalization {
	return &NullableLicenseLocalization{value: val, isSet: true}
}

func (v NullableLicenseLocalization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseLocalization) UnmarshalJSON(src []byte) error {
	v.isSet = true
